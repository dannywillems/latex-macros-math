...
%Already defined in physics package.\providecommand use \renewcommand if command exists, else, define.
...
%%% Hyperstructure and hyperelements
\newcommand\hyperstructure[1]{ { }^{*}#1}
\def\hyperreal{\hyperstructure{\real}}
\newcommand{\hyperelement}[1]{ { }^{*} #1}
\newcommand{\hyperelementUltra}[2]{ { }^{*} #1_{#2}}
\newcommand{\hyperelementSequence}[1]{[#1_{n}]}
\newcommand{\hyperelementSequenceNoIndice}[1]{[#1]}
\newcommand{\hyperelementSequenceFull}[1]{[(#1_{n})_{n \in \naturel}]}
\newcommand{\hyperelementSequenceFullNoIndice}[1]{[(#1)_{n \in \naturel}]}
\newcommand{\hyperelementSequenceUltra}[2]{[#1_{n}]_{#2}}

%%% Superstructure
\newcommand{\superstructureOf}[1]{V(#1)}

%%% Non standard version.
\newcommand{\nonStandardVersion}[1]{[#1]}
...
%%% Finite set
\newcommand{\finiteSet}[1]{Fin(#1)}

%%% Internal set and function.
\newcommand{\internalSet}[1]{[#1_{n}]}
\newcommand{\internalSetNoIndice}[1]{[#1]}
\newcommand{\setOfInternalSet}[1]{In(#1)}

\newcommand{\internalFunction}[1]{[#1_{n}]}
\newcommand{\internalFunctionNoIndice}[1]{[#1]}

%%% Monad
\newcommand{\monadOf}[1]{\mu(#1)}

%%% Infinely closed
\def\infinelyClosed{\approx}

%%% Near standard part of an element
\newcommand{\nearStandard}[1]{ns(#1)}
\newcommand{\nearStandardSetOf}[1]{ns(#1)}
\newcommand{\preNearStandard}[1]{pns(#1)}
\newcommand{\preNearStandardSetOf}[1]{pns(#1)}

%%% Superstructure
\newcommand{\superstructure}[1]{V(#1)}
...
% Notation for continuous function from one space to another.
%% DEPRECATED ?
\newcommand{\continuousSpaceFunction}[2]{\mathcal{C}(#1, #2)}
%-------------------------------------------------------------------------------
%Model theory
...
%-------------------------------------------------------------------------------
% Computer science
\newcommand{\wordLength}[1]{\abs{#1}}
%-------------------------------------------------------------------------------

%-------------------------------------------------------------------------------
% Categories
\newcommand{\category}[1]{\mathcal{#1}}
\newcommand{\categoryObjects}[1]{Obj(#1)}
\newcommand{\categoryMorphismsDef}[3]{Hom_{#1}(#2, #3)}
\newcommand{\categoryIdentity}[1]{Id_{#A}}

%% Usual categories
\def\setCategory{\mathfrak{Set}}
\def\vectorSpaceCategory{\mathfrak{Vect}}
\def\orderedSetCategory{\mathfrak{Ord}}
